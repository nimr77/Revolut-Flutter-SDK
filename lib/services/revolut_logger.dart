...
/// Logger service for Revolut SDK operations
/// This service receives callbacks from the native iOS plugin
class RevolutLogger {
  ...
  /// Initialize the logger and set up method channel handlers
  static void initialize() {
    _logChannel.setMethodCallHandler(_handleMethodCall);
  }

  /// Handle method calls from the native plugin
