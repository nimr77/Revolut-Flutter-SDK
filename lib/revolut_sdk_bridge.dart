...
class RevolutSdkBridge {
  ...
  static Future<bool> cleanupAllButtons() {
    return RevolutSdkBridgePlatform.instance.cleanupAllButtons();
  }
  ...
  /// Returns true if cleanup was successful
  static Future<bool> cleanupButton(int viewId) {
    return RevolutSdkBridgePlatform.instance.cleanupButton(viewId);
  }
